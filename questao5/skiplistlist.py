...
class SkiplistList(BaseList):
    ...
    def trucate(self, i):
        ...
        indice = 1
        while r1 >= 0:
            while (u1.next[r1] is not None) and (j + u1.length[r1] < i - 1):
                j+=u1.length[r1]
                u1 = u1.next[r1]
                indice +=u1.length[r1]
            if (j + u1.length[r1] == i -1)  and (u1.next[r1] is not None):
                u2.length[r2] = indice
                u2.next[r1] = u1.next[r1]
                u1.next[r1] = None
                l2.n = indice
            else:
                u2.length[r2] = u1.length[r1]
                u2.next[r1] = u1.next[r1]
                u1.next[r1] = None
            r1-=1
            r2-=1
        return f'Depois do metodo truncate \nl1 = {self} \nl2 = {l2}'
